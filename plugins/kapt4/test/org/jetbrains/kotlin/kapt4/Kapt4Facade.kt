...
private fun run(
    ...
    return KtAnalysisSessionProvider.getInstance(module.project).analyze(module) {
        ...
        with(context) { context to generateStubs(psiFiles.filterIsInstance<KtFile>(), options, onError,this@analyze, ::renderMetadata) }
    }
}
...
private fun renderMetadata(metadata: Metadata): String {
